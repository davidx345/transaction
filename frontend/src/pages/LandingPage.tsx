        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <motion.h1
              ...
              className="text-5xl lg:text-7xl font-bold tracking-tight mb-8 bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50"
            >
          ...
          >
            <div className="relative rounded-xl bg-[#1A1A1C] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9]">
